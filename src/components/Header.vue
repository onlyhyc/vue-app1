...
<header>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a href="/" class="navbar-brand">外卖点餐系统</a>
    <ul class="navbar-nav">
      <li class="nav-link">
      ...
      <li class="nav-link">
        <router-link :to="{name:'adminLink'}">管理</router-link>
      </li>
      <li class="nav-link">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-link">
        <router-link :to="{name:'loginLink'}" v-show="!isLogin">登录</router-link>
      </li>
      <li class="nav-link">
        {{currentUser}}
      </li>
      ...
      <li class="nav-link">
        <router-link :to="{name:'registerLink'}" v-show="!isLogin">注册</router-link>
      </li>
    </ul>
  </nav>
</header>
